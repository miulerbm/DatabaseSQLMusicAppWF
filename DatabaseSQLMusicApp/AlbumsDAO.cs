    ...
    internal class AlbumsDAO
    {
        ...
        public List<Album> getAllAlbums()
        {
            ...
            MySqlConnection connection = new MySqlConnection
                (connectionString);
            connection.Open(); // to log into the server
        ...
        internal int addOneAlbum(Album album)
        {
            ...
            // we use the AddWithValue using the @ wildcard property to add the remaining of our SQL statement.
        ...
        {
            // start with an empty list, but for Tracks:
        ...
        public List<JObject> getTracksUsingJoin(int albumID)
        {
            ...
            using (MySqlDataReader reader = command.ExecuteReader())
            {
                ...
                while (reader.Read())
                {
                    ...
                    // I can use Field count to get the exact amount of columns i have:
